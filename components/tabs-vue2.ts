...
const Tabs = Vue.extend({
    props: ['value', 'tabs'],
    render(this: Vue & {readonly value?: string, _v?: string, selected?: string, tabs: {readonly [key: string]: string}}): VNode {
        let children: { [key: string]: string | VNode | undefined };

        // I can't find a situation where this path is chosen.
