## 💾 Downloads
The latest release is **0.8.0-prerelease1**. Downloads are temporarily offline. Our sub-1.0 release number indicates that core features we'd like to deliver are still undergoing major development.
