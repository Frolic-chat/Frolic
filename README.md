## 💾 Downloads
The latest release is **0.8.8**. You can download it [on the release page](https://github.com/Frolic-chat/Frolic/releases/tag/0.8.8). Our sub-1.0 release number indicates that core features we'd like to deliver are still undergoing major development, even though the application is stable and reliable.
