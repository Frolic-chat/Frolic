...
## SPDX Identifiers
The SPDX identifiers provide programatic identification of licenses. They are included on a best-effort basis and are not guaranteed to be accurate. They are not copyright notices and do not have to be preserved either verbatim or "in spirit". Keeping them up to date with the most relevant information is a kindness to yourself and those who come after you. Identifiers do not modify, supersede, or supplant the license text. Parsing an SPDX identifier is not a replacement for reading the license. Removing an identifier does not modify the copyright of the work and does not absolve you of your responsibility to abide by the license terms. For more information on this matter, see the "Copyright notices" section of [the SPDX page on handling license info](https://spdx.dev/learn/handling-license-info/).
