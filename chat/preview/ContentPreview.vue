...
export default class ImagePreview extends Vue {
    ...
    @Hook('mounted')
    onMounted(): void {
        window.console.info('Mounted ImagePreview');
    ...
    async executeJavaScript(js: string | undefined, context: string = 'unknown', logDetails?: unknown): Promise<unknown> {
        /**
             * This is the point that checks if we're applying the "expand images" mutator or letting the page display naturally.
             */
        if (!this.runJs)
            return;
