...
Any existing FChat 3.0 data for this character will be overwritten.`,
    ...
    'rising.filter.naToFriends': 'Filters do not apply to friends or bookmarked characters, moderators of the current channel, or global operators in all channels.',
