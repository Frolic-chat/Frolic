...
Current log location: {1}`,
    ...
    'settings.browserOptionWarning.title': '⚠ Danger Zone! ⚠',
    'settings.browserOptionWarning.msg': 'This is an advanced setting. By changing this setting to an unsupported program (i.e. not a browser), you might not be able to open links from Frolic anymore.',
    'settings.browserOptionWarning.mac1': 'Mac User: As of writing, MacOS has a bug in how it handles opening links.',
    'settings.browserOptionWarning.mac2': 'When your default browser is something other than Safari and you select Safari in this settings window, links might be opened twice.',
    'settings.browserOptionWarning.mac3': 'Once in Safari and a second time in your default browser. This tends to happen when Safari is not running when clicking a link.',
...
Any existing FChat 3.0 data for this character will be overwritten.`,
    ...
    'settings.experiment.orientationMatching': 'Improve nonbinary gender matching',
    ...
    'settings.match.relaxlength.selectedInfo': 'In 0.7.3 length matching was reigned in; select this to expand your positive matches.',
