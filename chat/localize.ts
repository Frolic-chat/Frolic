...
Current log location: {1}`,
    ...
    'settings.expensiveMemberList': 'Automatically apply chat filters and bonus features to channel members',
    'settings.expensiveMemberList.selectedInfo': '⚠ This feature can cause very high memory consumption (300MB+ per very large room)',
    'settings.hideChannelMembers.selectedInfo': "Channel moderators and global ops will remain visible.",
    'settings.hideChannelMessages.selectedInfo': "Messages from channel moderators and global ops will remain visible.",
    'settings.hidePrivateMessages.selectedInfo': "Messages from global ops and moderators of any channel you're in will remain visible.",
...
Once this process has started, do not interrupt it or your logs will get corrupted even worse.`,
    ...
    'characterSheet.tabs.overview': 'Overview',
    'characterSheet.tabs.info': 'Info',
    'characterSheet.tabs.groups': 'Groups ({0})',
    'characterSheet.tabs.images': 'Images ({0})',
    'characterSheet.tabs.guestbook': 'Guestbook ({0})',
    'characterSheet.tabs.friends': 'Friends ({0})',
    'characterSheet.tabs.recon': 'Recon',
    'characterSheet.loading': 'Loading character information.',
    'characterSheet.banned': 'This character has been banned and is not visible to the public. Reason:',
    'characterSheet.timoutTime': 'Timeout expires:',
    'characterSheet.globalBlock': 'This character has been blocked and is not visible to the public. Reason:',
    'characterSheet.status': 'Status:',
    'profile.edit': 'Edit',
...
Any existing FChat 3.0 data for this character will be overwritten.`,
    ...
    'rising.misc.risingPortraits': 'Show high-quality portraits',
    ...
    'rising.filter.hideAds': 'Hide ads',
    'rising.filter.hideSearch': 'Hide from search results',
    'rising.filter.hideMembers': 'Hide from channel members lists',
    'rising.filter.hidePubChat': 'Hide public channel messages',
    'rising.filter.hidePrivChat': 'Hide private channel messages',
    'rising.filter.hidePMs': 'Hide private messages (PMs)',
    'rising.filter.showIcon': 'Show filter icon by name',
    'rising.filter.automate': 'Send an automatic "no thank you" if they message you',
    'rising.filter.penalize': 'Penalize match scores',
