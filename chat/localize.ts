...
Are you sure?`,
    ...
    'home.widgetOptions.switchTip': 'To quickly switch between home and console without changing your default setting, click on the Home tab on the sidebar while already on the home/console to switch to the other.',
...
Any existing FChat 3.0 data for this character will be overwritten.`,
    ...
    'settings.risingShowUnreadOfflineCount.help': 'Enabling this feature pings the f-list website and will show you in the "Friends Browsing the Site" section of the front page. New notes will continue to display even with message count diabled.',
