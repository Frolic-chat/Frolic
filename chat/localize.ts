...
Current log location: {1}`,
    ...
    'settings.expensiveMemberList': 'Automatically apply smartfilters and bonus features to channel members',
...
Any existing FChat 3.0 data for this character will be overwritten.`,
    ...
    'rising.header.visibilityCaveat': 'Users will only be filtered once their profile has been loaded (via opening their profile, mousing over their username, or viewing one of their ads).',
    ...
    'rising.filter.naToFriends': "Filters do not apply to friends or bookmarked characters, moderators of channels you're in, or global operators in any context.",
    'rising.filter.beta': 'Smartfilters are a perpetual work-in-progress. Some of these features and behaviors may be removed or significantly changed in the future.',
