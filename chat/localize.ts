...
SELECT THE TAB YOU WISH TO REPORT, LOGS ARE AUTOMATICALLY ATTACHED[/color]`,
    ...
    'settings.cg.desc1': 'Custom genders are a Frolic-specific feature that allow you to customize how your gender is displayed to other players and how your gender is used to match against other players when using the matchmaker.',
    'settings.cg.alert': '⚠ Alert!',
    'settings.cg.desc2': 'Currently, this feature is experimental. The specific method to send your gender info may change in the future. Please try this feature out and let us know how it works!',
    ...
    'settings.cg.nokinks': "If you don't select any kinks, the matchmaker will match you with other player as genderless. In most cases, this means gender won't be used to determine good matches.",
