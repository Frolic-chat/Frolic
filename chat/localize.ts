...
SELECT THE TAB YOU WISH TO REPORT, LOGS ARE AUTOMATICALLY ATTACHED[/color]`,
    ...
    'settings.hqp.copy': `Enter your image link into the box above. The text below will automatically display a ready-to-use link you can copy and paste into your profile.`,
...
Once this process has started, do not interrupt it or your logs will get corrupted even worse.`,
    ...
    'settings.conversationSettings.highlightUsernames': 'Notify for messages from these players in this channel:',
    'settings.conversationSettings.highlightUsernames.help': 'Full-name match only. Separate character names with commas. Case is ignored. You can also highlight a character by selecting "Watch" in the character right-click menu.',
