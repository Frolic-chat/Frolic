...
SELECT THE TAB YOU WISH TO REPORT, LOGS ARE AUTOMATICALLY ATTACHED[/color]`,
    ...
    'settings.hqp.copy': `Enter your image link into the box above. The text below will automatically display a ready-to-use link you can copy and paste into your profile description.`,
    ...
    'settings.cg.experimental': 'This feature is in testing. The exact benefit may improve over time. Only players who use Frolic will see your custom gender word, but your custom gender will still be used to determine your matchmaking compatibility with any character who fills out their kink list.',
    'settings.cg.word': "Enter your gender identity. This gender will appear to others viewing your profile.",
    'settings.cg.exampleGender': 'Example: Transman, Genderqueer, Null',
    'settings.cg.kinkDesc': "The matchmaker uses normal F-List kinks to determine if your gender is a good match for another's orientation. You can select any number of gender kinks below and your potential partner's kinks will be checked for a match.",
    'settings.cg.kinkExample': "Kinks are checked in order. For example - if your character is a transman, you can select trans male, male, and transgender in that order. If the other player has transmen in their favorites, you'll appear as a bright-green great match. If the user doesn't have transmen in their kinks but has men in their maybes, your gender will appear as a yellow slight-mismatch. If you select no gender kinks to match against, gender won't be used for matchmaking. (F-List has no genderless/null-gender kink to match against.)",
    'settings.cg.errorEmptyKinks': "Because F-list does not have a kink for \"I like genderless people\", selecting no gender will prevent gender from being used as a compatibility factor.",
    'settings.cg.copy': "Fill out the information above. The text below will automatically display a ready-to-use link you can paste into your profile description. It won't appear to anyone viewing your profile, but all Frolic users will see you as your chosen gender.",
    ...
    'settings.cg.errorLength': 'Your custom gender will be limited to 20 characters when others view it.',
...
Are you sure?`,
    ...
    'settings.clickOpensMessage.help': '',
    'settings.enterSend': 'Enter sends messages (shows send button if disabled)',
    'settings.enterSend.help': '',
    'settings.secondEnterSend': 'Require a SECOND Enter to send your messages.',
    ...
    'settings.logMessages': 'Log conversations to disk',
    ...
    'settings.expensiveMemberList': 'Automatically apply compatibility features to channel members',
    'settings.expensiveMemberList.help': '⚠ This feature can cause very high memory consumption (300MB+ per very large room)',
    'settings.fontSize': 'Font size',
    'settings.fontSize.help': 'Minimum: {0}; Maximum: {1}; Default: 14',
...
Any existing FChat 3.0 data for this character will be overwritten.`,
    ...
    'settings.risingAdScore.help': 'This enables core functionality in Frolic. In a future update, the underlying infrastructure will be enabled permanently, even if you disable the display of it.',
    ...
    'settings.risingCharacterTheme': 'Override UI theme',
    'settings.risingCharacterTheme.help': 'Applies to this character only',
    ...
    'settings.risingFilter.exceptionNames.help': "Separate names with the Enter key, so there's only one character on each line. Friends and bookmarked characters bypass filtering automatically.",
