...
Any existing FChat 3.0 data for this character will be overwritten.`,
    ...
    'settings.risingShowUnreadOfflineCount': 'Show offline message count on the home page and sidebar',
    'settings.risingShowUnreadOfflineCount.help': 'Enabling this feature pings the f-list website every 15 minutes and will show you in the "Friends Browsing the Site" section of the front page for 10 minutes afterwards.',
