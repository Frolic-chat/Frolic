...
Are you sure?`,
    ...
    'settings.enterSend.help': '',
    'settings.secondEnterSend': 'Safeguard: Require a second Enter press to send messages',
    'settings.secondEnterSend.help': '',
    'settings.disallowedTags': 'Disallowed BBCode tags:',
    'settings.disallowedTags.help': 'Separate tags with commas. Leave blank to allow all bbcode.',
    ...
    'settings.highlightWords.ph': 'Example: acute, obtuse, equilateral',
    'settings.showBroadcastsInPMs': 'Echo broadcasts in private messages',
    'settings.showBroadcastsInPMs.help': 'Broadcasts are messages sent to everyone by site administrators and may contain important information.',
    'settings.showAvatars': 'Show character avatars in the UI',
    'settings.showAvatars.help': '',
    'settings.animatedEicons': 'Animate [eicon]s',
    'settings.animatedEicons.help': '',
    'settings.idleTimer': 'Idle timer (minutes)',
    'settings.idleTimer.help': 'Minimum: {0}; Maximum: {1}; 0 to disable',
    ...
    'settings.logMessages.help': '',
    'settings.logChannels': 'Log channels',
    'settings.logChannels.help': '',
    'settings.logAds': 'Log ads',
    'settings.logAds.help': '',
    'settings.expensiveMemberList': 'Automatically apply compatibility features to the channel member list',
    'settings.expensiveMemberList.help': '⚠ This feature loads the profiles of characters you scroll past in the channel member list and can cause very high memory consumption (300MB+ per very large room)',
    'settings.fontSize': 'Font size',
    'settings.fontSize.help': 'This setting affects the entire application. Minimum: {0}; Maximum: {1}; Default: 14',
    ...
    'settings.colorBookmarks.help': '',
    'settings.bbCodeBar': 'Show BBCode formatting bar on text input',
    'settings.bbCodeBar.help': '',
    ...
    'settings.autoPinPMs': 'Automatically pin private message tabs',
...
Any existing FChat 3.0 data for this character will be overwritten.`,
    ...
    'rising.header.desc': 'Chat filters allow you to customize your experience to an extreme degree. Please use this feature cautiously.',
    ...
    'rising.header.match': 'Matching Parameters',
    'rising.header.exceptionList': 'Exception List',
    'settings.hideAds.title': 'Hidden Ads',
    'settings.hideAds.desc': `You can hide a character's ads by right-clicking their name and selecting "Hide ads"`,

    'settings.risingAdScore': 'Colorize ads, profiles, and names of compatible and incompatible characters',
    ...
    'settings.risingLinkPreview': 'Show a link/image preview when the mouse hovers over a link',
    ...
    'settings.risingAutoCompareKinks': 'Automatically compare kinks when viewing a character profile',
    ...
    'settings.risingShowUnreadOfflineCount': 'Include Message Center count on the home page',
    'settings.risingShowUnreadOfflineCount.help': 'Enabling this feature checks your "Messages" count on the f-list website every 15 minutes and will show you in the "Friends Browsing the Site" section of the front page.',
    'settings.risingColorblindMode': 'Colorblind mode',
    'settings.risingColorblindMode.help': 'Changes the gender coloring of usernames to contrast each other more distinctly',
    'settings.risingShowPortraitNearInput': 'Show character portrait by text input',
    'settings.risingShowPortraitNearInput.help': '',
    'settings.risingShowPortraitInMessage': 'Show character portrait with each message',
    ...
    'settings.risingCharacterTheme.help': 'You can change the global theme from the gear menu at the top of the window',
    ...
    'settings.risingFilter.hideAds': 'Hide ads',
    'settings.risingFilter.hideAds.help': '',
    'settings.risingFilter.hideSearchResults': 'Hide from search results',
    'settings.risingFilter.hideSearchResults.help': '',
    'settings.risingFilter.hideChannelMembers': 'Hide from channel members lists',
    'settings.risingFilter.hideChannelMembers.help': '',
    'settings.risingFilter.hidePublicChannelMessages': 'Hide public channel messages',
    'settings.risingFilter.hidePublicChannelMessages.help': '',
    'settings.risingFilter.hidePrivateChannelMessages': 'Hide private channel messages',
    'settings.risingFilter.hidePrivateChannelMessages.help': '',
    'settings.risingFilter.hidePrivateMessages': 'Hide private messages (PMs)',
 ...
 */
export default function l(key: LKeys, ...args: (string | number)[]): string {
