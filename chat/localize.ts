...
const strings: {[key: string]: string | undefined} = {
    ...
    'chat.unknownChar': 'Unknown character {0}',
...
Current log location: {1}`,
    ...
    'settings.browserOptionWarning.msg': 'This is an advanced setting. By changing this setting to an unsupported program (i.e. not a browser), you might not be able to open links from F-Chat anymore.',
