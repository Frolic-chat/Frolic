...
Are you sure?`,
    ...
    'settings.highlightWords.ph': 'Example: affine, self-similarity, expanding symmetry',
    'settings.highlightUsernames': 'Notify for messages from these players:',
    'settings.highlightUsernames.help': 'Separate player names with commas. Case is ignored.',
    'settings.highlightUsernames.ph': 'Example: Sierpiński, benoît mandelbrot',
    'settings.highlightUsersChannel': 'Allow usernames to match highlight words in this channel',
    'settings.highlightUsersChannel.help': '',
    ...
    'settings.joinMessageInThisChannel.help': '',
    ...
    'settings.friendMessageInThisChannel.help': '',
    ...
    'settings.defaultHighlights.help': '',
